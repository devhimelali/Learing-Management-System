<div class="navbar-header">
    <div class="d-flex">
        ...
        <div class="navbar-brand-box horizontal-logo">
            <a href="<?php ADMIN_URL . "/dashboard.php" ?>" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="<?php BASE_URL ?>assets/images/logo-sm.png" alt="" height="22">
                </span>
                <span class="logo-lg">
                    <img src="<?php BASE_URL ?>'assets/images/logo-dark.png" alt="" height="22">
                </span>
            </a>
            ...
            <a href="{{ route('redirect') }}" class="logo logo-light">
                ...
                <span class="logo-lg">
                    <img src="<?php BASE_URL ?>assets/images/logo-light.png" alt="" height="22">
                </span>
            </a>
        </div>
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="dropdown topbar-head-dropdown ms-1 header-item">
            ...
            <div class="p-2 dropdown-menu dropdown-menu-end" id="light-dark-mode">
                <a href="#!" class="dropdown-item" data-mode="light"><i class="align-middle bi bi-sun me-2"></i> Default
                    (light mode)</a>
                <a href="#!" class="dropdown-item" data-mode="dark"><i class="align-middle bi bi-moon me-2"></i>
                    Dark</a>
                <a href="#!" class="dropdown-item" data-mode="auto"><i class="align-middle bi bi-moon-stars me-2"></i>
                    Auto (system default)</a>
            </div>
        </div>
        <div class="ms-1 header-item d-none d-sm-flex">
            <a href="<?= BASE_URL ?>" class="btn btn-icon btn-topbar btn-ghost-dark rounded-circle"
